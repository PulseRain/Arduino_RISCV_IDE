...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1192,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1193,                       /* -mcmodel= */
  OPT_mdiv = 1194,                           /* -mdiv */
  OPT_mexplicit_relocs = 1195,               /* -mexplicit-relocs */
  OPT_mfdiv = 1196,                          /* -mfdiv */
  OPT_mplt = 1197,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1198,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1199,                         /* -mrelax */
  OPT_msave_restore = 1200,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1201,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1202,                  /* -mstrict-align */
  OPT_mtune_ = 1203,                         /* -mtune= */
  OPT_n = 1204,                              /* -n */
  ...
  OPT_static_pie = 1254,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1262,                      /* -std=c++2a */
  OPT_std_c__98 = 1263,                      /* -std=c++98 */
  OPT_std_c11 = 1264,                        /* -std=c11 */
  OPT_std_c17 = 1265,                        /* -std=c17 */
  /* OPT_std_c18 = 1266, */                  /* -std=c18 */
  /* OPT_std_c1x = 1267, */                  /* -std=c1x */
  /* OPT_std_c89 = 1268, */                  /* -std=c89 */
  OPT_std_c90 = 1269,                        /* -std=c90 */
  OPT_std_c99 = 1270,                        /* -std=c99 */
  /* OPT_std_c9x = 1271, */                  /* -std=c9x */
  OPT_std_f2003 = 1272,                      /* -std=f2003 */
  OPT_std_f2008 = 1273,                      /* -std=f2008 */
  OPT_std_f2008ts = 1274,                    /* -std=f2008ts */
  OPT_std_f2018 = 1275,                      /* -std=f2018 */
  OPT_std_f95 = 1276,                        /* -std=f95 */
  OPT_std_gnu = 1277,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1278, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1279, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1280,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1281,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1282,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1283, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1284, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1285,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1286,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1287,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1288,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1289, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1290, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1291, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1292,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1293,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1294, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1295, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1296,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1297, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1298, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1299, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1300, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1301, */         /* -std=iso9899:2018 */
